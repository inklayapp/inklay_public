...
void getDeviceImage(const char *host) {
    ...
    // The cloud function function can be called with the following url (http post request).
    // https://europe-west1-inklay-ad9a1.cloudfunctions.net/getImage

    // The macaddress needs to be sent as json body:
    
    // {
    //     "macAddress":"24:6F:28:D1:5D:DC"
    // }

    // The functions returns the timestamp and a formatted time.
...
void renderImage(const char *host, const char *url) {
    ...
    // client.print(String("GET ") + "http://www.vision11.ch/inklay/inklay_web_updater/inklay.bmp" + " HTTP/1.1\r\n" + "Host: " + "www.vision11.ch" + "\r\n" + "User-Agent: ESP32\r\n" + "Connection: close\r\n\r\n");
